package com.image.backend.config;

import com.fasterxml.classmate.TypeResolver;
import com.image.backend.util.annotations.ApiInformation;
import com.image.backend.util.status.AdditionalModel;
import com.image.backend.util.status.EnumUtil;
...
public class SwaggerConfig implements WebMvcConfigurer, WebMvcOpenApiTransformationFilter {
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfoBuilder()
                .title("Image Backend")
                .description("Image Backend Documentation")
                .version(version)
                .build();
    }
    ...
    public List<Tag> getTags() {
        ...
        for (var controllerClass : scanner.findTypes("com.image.backend.controller")) {
            try {
